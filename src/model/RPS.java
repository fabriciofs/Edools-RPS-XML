...
public class RPS {
	...
	String servicos_codigoMunicipio;
	String prestador_cnpj;
	...
	String complemento;
	String bairro;
	String endereco_codigoMunicipio;
	String uf;
	String cep;
	String email;
	...
	public String getServicos_codigoMunicipio() {
		return servicos_codigoMunicipio;
	}

	public void setServicos_codigoMunicipio(String servicos_codigoMunicipio) {
		this.servicos_codigoMunicipio = servicos_codigoMunicipio;
	}
	...
	public String getEndereco_codigoMunicipio() {
		return endereco_codigoMunicipio;
	}

	public void setEndereco_codigoMunicipio(String endereco_codigoMunicipio) {
		this.endereco_codigoMunicipio = endereco_codigoMunicipio;
	}
